...
UCurveRotatorFactory::UCurveRotatorFactory(const FObjectInitializer& ObjectInitializer)
...
UObject* UCurveRotatorFactory::FactoryCreateNew(UClass* Class, UObject* InParent, FName Name, EObjectFlags Flags, UObject* Context, FFeedbackContext* Warn)
{
